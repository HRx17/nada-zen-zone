  ...
  return (
    <div className="space-y-6">
            ...
            <button
              ...
              className={`group p-5 rounded-xl text-left transition-all duration-200 border-2 ${
                selectedChapter === index
                  ...
                  : "bg-muted/50 border-transparent hover:border-primary hover:bg-card elevation-1"
              }`}
      ...
      <div className="bg-card border-2 border-border rounded-2xl p-6 elevation-2">
        ...
        {showJargon && (
          <div className="grid sm:grid-cols-2 gap-4 mt-5 animate-in fade-in duration-300">
            {lessonData.jargon?.map((item, index) => (
              <div
                key={index}
                className="group p-5 rounded-xl bg-muted/50 border-2 border-transparent hover:border-secondary hover:bg-card transition-all duration-200 elevation-1"
              >
